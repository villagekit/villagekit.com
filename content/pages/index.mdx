...
Village Kit is a platform for open source, modular living infrastructure that evolves with you.
...
&zwnj;<Text bg='yellow.4' color='black' sx={{ display: 'inline-block', paddingX: 2 }}>Grant and Sarah</Text> are in Hamilton and have a child on the way. They order a Village Kit crib kit from a **local supplier**. The design has been certified to meet NZ Standards. The crib is made from **local timber** and is shipped a **short distance to their house**.
...
**Village Kit** starts with a modern adaptation of the open design system **Grid Beam** into a social enterprise.
...
Village Kit continues the evolution with:
